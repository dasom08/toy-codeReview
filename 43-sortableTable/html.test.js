...
var sortableTableDir = `${__dirname}/sortableTable.js`;
var indexDir = `${__dirname}/index.html`;
var JSDOM = jsdom.JSDOM;
var window = new JSDOM(fs.readFileSync(indexDir)).window;

global.$ = require('jquery')(window);

vm.runInThisContext(fs.readFileSync(sortableTableDir), sortableTableDir);
